...
# ------------------------------------------------------
dir_out = '~/Dropbox (Personal)/workspace_phd/papers/paper_8_dboost/experiment_network_b_q/'
...
# ---
# --- model specs:
model_methods = c(random_forest_5 = 'bag_fit',
                  random_forest_10 = 'bag_fit',
                  random_forest_50 = 'bag_fit',
                  random_forest_100 = 'bag_fit',
                  random_forest_500 = 'bag_fit',
                  spot_forest_5 = 'bag_fit',
                  spot_forest_10 = 'bag_fit',
                  spot_forest_50 = 'bag_fit',
                  spot_forest_100 = 'bag_fit',
                  spot_forest_500 = 'bag_fit',
                  boost_5 = 'boost_fit',
                  boost_10 = 'boost_fit',
                  boost_50 = 'boost_fit',
                  boost_100 = 'boost_fit',
                  ...
                  dboost_10 = 'boost_fit',
                  dboost_50 = 'boost_fit',
                  dboost_100 = 'boost_fit',
                  dboost_500 = 'boost_fit')
...
weight_tol = 10^-6
objective_tol = 10^-6
n_samples = c(5,10,50,100,500)

# --- args templates:
rf_args = lapply(n_samples,function(ns){
...
spot_forest_args = lapply(n_samples,function(ns){
  list(model_method = 'dtree_fit',
       model_args = list(max_depth = max_depth,
                         min_obs = min_obs,
                         step_size = step_size,
...
boost_args = lapply(n_samples,function(ns){
  list(model_method = 'dtree_fit',
       model_args = list(max_depth = max_depth,
                         min_obs = min_obs,
                         step_size = step_size,
...
dboost_args = lapply(n_samples,function(ns){
  list(model_method = 'dtree_fit',
       model_args = list(max_depth = max_depth,
                         min_obs = min_obs,
                         step_size = step_size,
...
model_args = c(rf_args,spot_forest_args,boost_args,dboost_args)
